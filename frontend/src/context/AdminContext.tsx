...
const mapTest = (t: any): Test => ({ id: t._id || t.id, _id: t._id || t.id, title: t.title, testType: t.testType || 'Chapter', duration: t.duration || 15, subjectId: t.subjectId, chapterId: t.chapterId, questions: t.questions || [], isDynamic: t.isDynamic, examIds: t.examIds, studentTypeIds: t.studentTypeIds, marksPerQuestion: t.marksPerQuestion, negativeMarksPerQuestion: t.negativeMarksPerQuestion, retakeLimit: t.retakeLimit ?? 0, isFullSyllabus: t.isFullSyllabus, instructions: t.instructions, status: t.status, subjectConfigs: t.subjectConfigs, dynamicTotalQuestions: t.dynamicTotalQuestions, targetDifficulty: t.targetDifficulty });
const mapTimetable = (t: any): Timetable => ({
  ...
  date: t.date,
  scheduleType: t.scheduleType || 'weekly',
